...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { first_name: @faculty.first_name, last_name: @faculty.last_name, subject: @faculty.subject, title: @faculty.title } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { first_name: @faculty.first_name, last_name: @faculty.last_name, subject: @faculty.subject, title: @faculty.title } }
